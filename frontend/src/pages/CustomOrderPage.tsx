...
function PaperclipIcon() {
  // Path несимметричен — визуальный центр смещён немного вверх-влево
  // от центра viewBox. Сдвигаем вниз на 1px чтобы оптически
  // выровняться с send-arrow по вертикали.
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" aria-hidden style={{ transform: "translateY(1px)" }}>
