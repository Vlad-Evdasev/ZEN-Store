...
function App() {
  ...
  return (
    ...
    <div className="zen-app" style={styles.app}>
      ...
      <main ref={mainScrollRef} className={page === "catalog" ? "zen-main--catalog" : page === "favorites" ? "zen-main--edge" : undefined} style={page === "support" ? { ...styles.main, paddingBottom: 0 } : styles.main}>
