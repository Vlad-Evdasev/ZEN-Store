...
// При RADIUS=85 и диаметре 40px безопасный угловой шаг ≈ 2·asin(25/85) ≈ 34°,
// что даёт ~10px зазор между соседними кружками (без перекрытий).
// Порядок: Поддержка (90°, строго справа на уровне бургера) → История → Отзывы → Настройки (-12°, под бургером и чуть левее).
const RADIUS = 85;
const ANGLES_DEG = [90, 56, 22, -12];
