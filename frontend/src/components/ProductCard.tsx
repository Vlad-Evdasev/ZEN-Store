...
const styles: Record<string, React.CSSProperties> = {
  ...
  descBottomRow: {
    ...
    alignItems: "baseline",
    gap: 8,
    padding: "0 calc(8px + var(--card-desc-bleed, 2px)) 10px calc(8px + var(--card-desc-bleed, 2px))",
    minHeight: 0,
    margin: 0,
    lineHeight: 1.25,
  },
  descBottomRowCompact: {
    ...
    alignItems: "baseline",
    gap: 6,
    padding: "0 calc(6px + var(--card-desc-bleed, 2px)) 8px calc(6px + var(--card-desc-bleed, 2px))",
    minHeight: 0,
    margin: 0,
    lineHeight: 1.25,
  },
